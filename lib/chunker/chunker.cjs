  ...
  (0, _createClass2["default"])(Chunker, [{
    ...
    value: function layout(content, startAt) {
      ...
      return (0, _wrapAsyncGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
        var breakToken, page, prevPage, prevNumPages, addedExtra, emptyBody, emptyFootnotes, emptyPage;
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            ...
            case 1:
              ...
              addedExtra = false;
              emptyBody = !page || !page.area.firstElementChild.childElementCount || !page.area.firstElementChild.firstElementChild.getBoundingClientRect().height;
              emptyFootnotes = !page || !page.footnotesArea.firstElementChild.childElementCount || !page.footnotesArea.firstElementChild.firstElementChild.getBoundingClientRect().height;
              emptyPage = emptyBody && emptyFootnotes;
              prevNumPages = _this.total;
              if (!(!page || !emptyPage)) {
                _context6.next = 20;
                break;
              }
              ...
              _context6.next = 12;
              return (0, _awaitAsyncGenerator2["default"])(_this.handleBreaks(breakToken.overflow[0].node));
            case 12:
              _context6.next = 16;
              break;
            case 14:
            ...
            case 20:
              addedExtra = _this.total != prevNumPages;
              ...
              page = _this.pages[_this.total - 1];
              _context6.next = 25;
            ...
            case 25:
              ...
              _context6.next = 29;
              return (0, _awaitAsyncGenerator2["default"])(page.layout(content, breakToken, prevPage));
            case 29:
